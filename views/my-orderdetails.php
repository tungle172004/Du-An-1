...
<div class="container pt-4" style="margin-bottom: 200px;">
    <article class="card">
        ...
        <div class="card-body">
            ...
            <div class="track">
                <?php if($status!=5) { $tam="active"?>
                <div class="step <?= $tam?>"> <span class="icon"> <i class="fa fa-check text-black"></i> </span> <span class="text">Chờ xác nhận</span> </div>
                <?php }?>
                ...
                <div class="step <?php if($status == 5) echo 'active'?>"> 
                    <span class="icon"> <i class="fa fa-times text-black"></i> </span> <span class="text text-black">Đã hủy </span> 
                </div>
            </div>
            <hr>
            <ul class="row">
