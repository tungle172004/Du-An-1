        ...
        <div class="row">
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" style="border-radius: 10px;">
                        ...
                        <div class="carousel-item" >
                            <img class="img-fluid" src="public/img/banner/bantra.PNG" alt="Image">
                            
                        </div>
                        <div class="carousel-item" >
                            <img class="img-fluid" src="public/img/banner/bannergiuong.jpg" alt="Image">
            ...
            <div class="col-lg-4">
                <div class="product-offer" >
                    <img class="img-fluid" src="public/img/banner/banner-1.PNG" alt="">
                    
                </div>
                <div class="product-offer">
                    <img class="img-fluid" src="public/img/banner/banner2.JPG" alt="">
...
<!-- Banner Section Begin -->
<section class="banner set-bg" data-setbg="public/img/banner/bantra.png"  style="opacity:0.8 ; background-color: black;">
    <div class="container">
        <div class="row">
                ...
                <div class="banner__slider owl-carousel">
                    <div class="banner__item">
                        ...
                        <div class="banner__text">
                            ...
                            <h1 style="color: #F4F4F9;">Phòng ngủ</h1>
                    ...
                    <div class="banner__item">
                        <div class="banner__text">
                            <span>Bộ sưu tập</span>
                            <h1 style="color: #F4F4F9;">Combo Giá Siêu Tốt</h1>
                            <a href="cua-hang">Mua ngay</a>
                        </div>
                    </div>
                    <div class="banner__item">
        ...
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="discount__pic">
                    <img src="public/img/sale44.webp" alt="Hình ảnh">
                </div>
            </div>
            <div class="col-lg-6 p-0">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="services__item">
                    ...
                    <p>Cho tất cả các đơn hàng trên 2.000.000đ</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="services__item">
