<body>
    ...
    if(isset($_SESSION['user'])) {
        ...
        $count_carts = count($CartModel->count_cart($user));
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__logo">
            <a href="index.php"><img src="public/img/logoduan.PNG" alt=""></a>
        </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-2">
                    <div class="header__logo">
                        <a href="index.php"><img style="max-height: 50px" src="public/img/logoduan.PNG" alt=""></a>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="./public/blog.html">BÀI viẾT</a></li>
